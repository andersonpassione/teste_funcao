...
namespace FI.AtividadeEntrevista.DAL
{
    internal class DaoBeneficiario : AcessoDados
    {
        ...
        internal long Incluir(DML.Beneficiario beneficiario)
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("Cpf", FormatarCPFGravacaoBD(beneficiario.Cpf)));
        ...
        internal List<DML.Beneficiario> Listar()
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("Id", 0)); //Ver se no caso do beneficiario não precise filtrar pelo ID do Cliente
